...
public class CanadaTicket {
    ...
    public CanadaTicket(Long id, String departure, String arrival, LocalDateTime date, String price, int stock, String operationAirline, String flightid, boolean sale) {
        this.id = id;
